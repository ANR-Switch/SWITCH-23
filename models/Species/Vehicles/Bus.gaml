...
//			}
	...
	action propose {
		write "The methof: propose() should not be called on a Bus agent: " + name color:#red;
	}
	
	action enter_road(Road road){
		//
		write "The method: enter_road() should not be called on a Bus agent: " + name color:#red;
	}
